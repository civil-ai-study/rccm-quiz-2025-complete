...
def river_sabo_complete_test():
    ...
    try:
        ...
        # 部門名をURLエンコード
        department_encoded = urllib.parse.quote('河川・砂防')
        ...
        # カテゴリ情報の確認
        if "河川" in exam_content or "砂防" in exam_content:
            categories_found.add("河川・砂防")
            print("OK 河川・砂防カテゴリ確認")
